	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		auth.jdbcAuthentication().dataSource(dataSource)
				...
				.authoritiesByUsernameQuery(
						"select funcionario.email as username, papel.nome as authority " +
						"from permissoes " +
						"inner join funcionario on funcionario.id = permissoes.funcionario_id " +
						"inner join papel on permissoes.papel_id = papel.id " +
